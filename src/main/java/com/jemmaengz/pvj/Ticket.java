...
public class Ticket {
  ...
  private String contentTicket = "{{nameLocal}}\n"+
    ...
    "DOMICILIO CONOCIDO ALLENDE # 224.\n"+
    "=============================\n"+
    "Ticket # {{ticket}}\n"+
    "LE ATENDIO: {{cajero}}\n"+
    "{{dateTime}}\n"+
  ...
  Ticket(String nameLocal, String expedition, String ticket, String dateTime, String items, String total, String recibo, String change) {
